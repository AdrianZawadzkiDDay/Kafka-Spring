...
class KafkaProperties {
    ...
    Map<String, Object> getSafeProperties() {
        ...
        /* below safe consumer settings (additionally use manual commit in listeners, use rebalance listerner...)*/
    ...
    Map<String, Object> getFastProperties() {
        ...
        /* fast consumer settings (additionally use auto commit without rebalance listener)*/
